...
router.post('/user',authenticateToken,userController.registerUser);//Route for registeruser
router.post('/login',authenticateToken,userController.loginUser);//route for loginuser
